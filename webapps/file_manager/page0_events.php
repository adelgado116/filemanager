...
//ships_tblSearch_s_SHIP_NAME_BeforeShow @15-4C8ACAC2
...
//PTAutocomplete2 BeforeShow @18-D0750AE6
    $Component->Attributes->SetValue('id', 'ships_tblSearchs_IMO_NUMBER');
//End PTAutocomplete2 BeforeShow

//Close ships_tblSearch_s_IMO_NUMBER_BeforeShow @17-1C7836CE
...
//PTAutocomplete1 Initialization @16-49135B9D
    global $Charset;
...
//PTAutocomplete1 DataSource @16-63D40112
...
//PTAutocomplete2 DataSource @18-46F1B2A6
        $Service->DataSource = new clsDBhss_db();
        $Service->ds = & $Service->DataSource;
        $Service->DataSource->SQL = "SELECT * \n" .
"FROM ships_tbl {SQL_Where} {SQL_OrderBy}";
...
//PTAutocomplete2 Charset @18-4F7C968C
        $Service->AddHttpHeader("Content-type", "text/html; charset=" . $Charset);
//End PTAutocomplete2 Charset

//PTAutocomplete2 DataFields @18-52A486F0
        $Service->AddDataSourceField('IMO_NUMBER');
//End PTAutocomplete2 DataFields

//PTAutocomplete2 Execution @18-D749E478
        $Service->DisplayHeaders();
        echo $Service->Execute();
//End PTAutocomplete2 Execution

//PTAutocomplete2 Tail @18-27890EF8
        exit;
    }
