...
<head>
	...
	function sendFileToServer(formData,status,folder)
	{
		switch(folder) {
			case 1:
				folder = "additional_docs";
				break;
			case 2:
				folder = "pictures";
				break;
			case 3:
				folder = "service_report";
				break;
			case 4:
				folder = "worksheet";
				break;
		...
		var uploadURL ="upload.php?imo=<?php echo $imo; ?>&order=<?php echo $order; ?>&folder=" + folder ; //Upload URL
	...
	var updateFiles = function( folder ) {
		...
		$.post("retrieve_files_list.php?IMO_NUMBER=<?php echo $imo; ?>&ORDER_NO=<?php echo $order; ?>&path=<?php echo $order_dir_path; ?>&SHIP_NAME=<?php echo $res1_value['SHIP_NAME']; ?>&folder=" + folder, function(data) {
	...
	updateFiles( "additional_docs" );
	updateFiles( "pictures" );
	updateFiles( "service_report" );
	updateFiles( "worksheet" );
...
<table width="100%" border="0">
	...
	<tr>
		<td width="8%">Service Order</td><td width="9%">IMO</td><td width="35%">Ship Name</td>
	...
	<tr>
		...
		<td>
		<?php
		if ( strchr( $_SERVER['HTTP_REFERER'], "http://freja/webapps/file_manager/page1.php" ) || strchr( $_SERVER['HTTP_REFERER'], "http://freja/webapps/file_manager/page2" ) || !isset( $_SERVER['HTTP_REFERER'] ) || strchr( $_SERVER['HTTP_REFERER'], "http://".$_SERVER['SERVER_ADDR']."/webapps/file_manager/page2" )  || strchr( $_SERVER['HTTP_REFERER'], "http://".$_SERVER['SERVER_ADDR']."/webapps/file_manager/page1" ) ) {
		?>
		
		<div align="left">&nbsp;<a href="page1.php?IMO_NUMBER=<?php echo $imo; ?>"><strong>LIST OF SERVICES FOR: <?php echo $res1_value['SHIP_NAME']; ?></strong></a></div>
