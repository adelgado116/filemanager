...
<form action="reports_viewer.php" method="post" target="results_iframe" >
...
<iframe id="results_iframe" name="results_iframe" src="reports_viewer.php?filter_submitter=<?php echo $_REQUEST['filter_submitter']; ?>" width="575" height="500" frameborder="0" ></iframe>
