      ...
      <table class="tableText">
        <thead>
          <tr> 
			...
			<td colspan="2" align="right"><a title="export list to xls file" href="export.php?filter_report_type=<?php echo $report_type; ?>&filter_submitter=<?php echo $submitter; ?>&filter_reference=<?php echo $reference ?>&filter_date_day=<?php echo $day; ?>&filter_date_month=<?php echo $month; ?>&filter_date_year=<?php echo $year; ?>" target="_blank">>> export this list >></a></td>
          </tr>
		  <tr>
