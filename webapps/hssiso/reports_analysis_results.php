        ...
        <thead>
          <tr> 
            <td colspan="2" align="left">
				<font class="tableTitle">RESULTS</font>
			</td>				
			<td colspan="4" align="right">
				<a title="export this list to xls file" href="export_other.php" target="_blank">export other</a>
				&nbsp;|&nbsp;
				<a title="export report to xls file" href="export_stats.php" target="_blank">export full report</a>
			</td> 
          </tr>
		  <tr>
          ...
          <TR bgcolor=<?php echo $bgcol; ?> > 
            ...
            <TD align="center"> 
              <?php
				...
				echo /*$row['rep_name'].*/'RAN-'.$row['doc_code'].'-'.$reports[$rowNumb]['sub_cat_id'];
			?>
            </TD>
            <!-- row n, column m+1 -->
			...
			<?php
				...
				if ($reports[$rowNumb]['date_year'].$reports[$rowNumb]['date_month'].$reports[$rowNumb]['date_day'] >= "20150219") {  // check for implementation on RAN 19-FEB-2015
					if ( $reports[$rowNumb]['status']  == 'closed' ) {				
						$path_to_report = 'repository/RAN-'.$row['doc_code'].'-'.$reports[$rowNumb]['sub_cat_id'].'_revd.pdf';
					} else if ( $reports[$rowNumb]['status']  == 'open' ) {
						$path_to_report = 'repository/RAN-'.$row['doc_code'].'-'.$reports[$rowNumb]['sub_cat_id'].'.pdf';
					}
				}else{
					if ( $reports[$rowNumb]['status']  == 'closed' ) {				
