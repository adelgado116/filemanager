...
<div id="resultsContainer_analysis">
    ...
    <form name="page_sel" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post">
      <table class="tableText">
        <thead>
          <tr> 
            <td colspan="4" align="left"><font class="tableTitle">RESULTS</font></td>
			<td colspan="2" align="right"><a title="export list to text file" href="export.php?filter_report_type=<?php echo $report_type; ?>&filter_submitter=<?php echo $submitter; ?>&filter_reference=<?php echo $reference ?>&filter_date_day=<?php echo $day; ?>&filter_date_month=<?php echo $month; ?>&filter_date_year=<?php echo $year; ?>" target="_blank">>> export this list >></a></td>
          </tr>
		  <tr>
		  <td align="left" colspan="6">
		  	Total Reports = <?php echo $total; ?>&nbsp;&nbsp;&nbsp;<strong>|</strong>&nbsp;&nbsp;&nbsp;Total Matches = <?php echo $rowsQty; ?>&nbsp;&nbsp;&nbsp;<strong>|</strong>&nbsp;&nbsp;&nbsp;Results % (of Total) = <?php echo number_format( ($rowsQty/$total)*100, 2 ); ?>
		  </td>
		  </tr>
		...
		?>
          <TR bgcolor=<?php echo $bgcol; ?> > 
			...
			?>			
				...
				<?php
				if ( $reports[$rowNumb]['status'] == "open" ) {
				
					?>
					<a title="click to set preventive actions" href="set_preventive_actions.php?current=<?php echo $currentPage; ?>&filter_report_type=<?php echo $report_type; ?>&filter_submitter=<?php echo $submitter; ?>&filter_reference=<?php echo $reference ?>&filter_date_day=<?php echo $day; ?>&filter_date_month=<?php echo $month; ?>&filter_date_year=<?php echo $year; ?>&record_id=<?php echo $reports[$rowNumb]['report_id']; ?>&report_name=<?php echo 'HSS-'.$row['doc_code'].'-'.$reports[$rowNumb]['sub_cat_id'].'.pdf'; ?>&set_preventive=1">process</a>
					<?php
		...
		?></TR>
          ...
          <tr> 
			...
			<a href="reports_analysis_results.php?current=<?php echo $currentPage; ?>&filter_report_type=<?php echo $report_type; ?>&filter_submitter=<?php echo $submitter; ?>&filter_reference=<?php echo $reference ?>&filter_date_day=<?php echo $day; ?>&filter_date_month=<?php echo $month; ?>&filter_date_year=<?php echo $year; ?>&page=first">&lt;| first page</a>
			<a href="reports_analysis_results.php?current=<?php echo $currentPage; ?>&filter_report_type=<?php echo $report_type; ?>&filter_submitter=<?php echo $submitter; ?>&filter_reference=<?php echo $reference ?>&filter_date_day=<?php echo $day; ?>&filter_date_month=<?php echo $month; ?>&filter_date_year=<?php echo $year; ?>&page=prev">&lt;&lt; prev page</a>
			<?php echo ' [ '; ?>
			...
			<a href="reports_analysis_results.php?current=<?php echo $currentPage; ?>&filter_report_type=<?php echo $report_type; ?>&filter_submitter=<?php echo $submitter; ?>&filter_reference=<?php echo $reference ?>&filter_date_day=<?php echo $day; ?>&filter_date_month=<?php echo $month; ?>&filter_date_year=<?php echo $year; ?>&page=next">next page &gt;&gt;</a>
			<a href="reports_analysis_results.php?current=<?php echo $currentPage; ?>&filter_report_type=<?php echo $report_type; ?>&filter_submitter=<?php echo $submitter; ?>&filter_reference=<?php echo $reference ?>&filter_date_day=<?php echo $day; ?>&filter_date_month=<?php echo $month; ?>&filter_date_year=<?php echo $year; ?>&page=last">last page |&gt;</a>
			</td>
          </tr>
        </tbody>
      </table>
...
<?php } else {
	...
	header('Location: reports_analysis_results.php?select_page='.$_REQUEST['select_page'].'&current='.$_REQUEST['pagenumber'].'&filter_report_type='.$report_type.'&filter_submitter='.$submitter.'&filter_reference='.$reference.'&filter_date_day='.$day.'&filter_date_month='.$month.'&filter_date_year='.$year );
