...
class clsGridequipment_manufacturer_tb1 { //equipment_manufacturer_tb1 class @2-16FC1DF1
...
//Class_Initialize Event @2-A9DC5031
    function clsGridequipment_manufacturer_tb1($RelativePath, & $Parent)
    {
        ...
        $this->EQUIP_MODEL->Page = "page2.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->EQUIP_MODEL->Parameters = "";
                $this->EQUIP_MODEL->Parameters = CCAddParam($this->EQUIP_MODEL->Parameters, "EQUIP_ID", $this->DataSource->f("EQUIP_ID"));
...
} //End equipment_manufacturer_tb1 Class @2-FCB6E20C

class clsequipment_manufacturer_tb1DataSource extends clsDBhss_db {  //equipment_manufacturer_tb1DataSource Class @2-F0E30DC2

//DataSource Variables @2-B8CDAB9B
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-B9FB7DCE
...
//Prepare Method @2-EDA34A87
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urls_EQUIP_TYPE_ID", ccsInteger, "", "", $this->Parameters["urls_EQUIP_TYPE_ID"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "equipment_model_tbl.EQUIP_TYPE_ID", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-A9F33BAC
    function Open()
    {
        ...
        $this->SQL = "SELECT equipment_model_tbl.*, MANUF_NAME \n\n" .
        "FROM equipment_model_tbl INNER JOIN equipment_manufacturer_tbl ON\n\n" .
...
} //End equipment_manufacturer_tb1DataSource Class @2-FCB6E20C

class clsRecordequipment_manufacturer_tb { //equipment_manufacturer_tb Class @8-E0047D13
...
//Class_Initialize Event @8-E44F1EA2
...
} //End equipment_manufacturer_tb Class @8-FCB6E20C
