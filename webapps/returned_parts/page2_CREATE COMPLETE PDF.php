...
if ( $meta_5 == "HSSINT" ) {
	...
	$path = '../../data/Admin/Service Coordinator Files/Service Raports/'.$imo.'/'.$meta_5.'/additional_docs/RP';
...
$pdf->Cell(35,$lineHeight + 2, 'HSS Order No.: ', 'LTB', 0);
...
$pdf->Cell(30);
//Title
$pdf->Cell(100,10,'Returned Parts Sheet',0,1,'C');
//Horizontal line to separate header
$pdf->Cell(0, 2, '', 'T', 0, 'C');
//Line break
$pdf->Ln(5);
...
$pdf->Cell(45,$lineHeight, 'Vessel: ', 'LTB', 0);
$pdf->Cell(140,$lineHeight, $shipname, 'LTRB', 1, 'C');
//$pdf->Cell(140,$lineHeight, '', 'LTRB', 1, 'C');
...
$pdf->Rect( 10, 235, 185, $lineHeight * 3 );
$pdf->MultiCell(185, $lineHeight - 3 , $data['fault_description'], '0', 1, 'L');
//$pdf->MultiCell(185, $lineHeight - 3 , '', '0', 1, 'L');
...
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Arial','',14);
$pdf->Cell(85,5,'Send to Logistics', 1, 1, 'C');
