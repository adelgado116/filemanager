...
//Class_Initialize Event @2-3E882791
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->emp_name->Parameters = CCAddParam($this->emp_name->Parameters, "tech_id", $this->DataSource->f("emp_id"));
...
//DataSource Variables @2-94FEFE2F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-DAA1F02A
