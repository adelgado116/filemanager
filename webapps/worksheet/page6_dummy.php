...
function create_worksheet( /*$wsData, $wsData2, $serviceData, $itemData, $pageNo, $totalPages, $path_root, &$path_complete*/ ) {
         ...
         $pdf->Cell(100,10, 'Order No.:  '."________"/*$serviceData['ORDER_NO']*/, 0,1,'C');

         $pdf->SetXY(110,16);
         $pdf->SetFont('Arial','',12);  //Arial normal 16
         $pdf->Cell(100,10, '(Page __ of __)', 0,1,'C');

         // date
         $pdf->SetXY(110, 23);
         $pdf->SetFont('Arial','',12);  //Arial normal 16
         $pdf->Cell(100,10, 'Date:  '.'__ / __ / ____'/*.date('j / M / Y')*/, 0,1,'C');
		...
		# evaluations
         ...
         //$path_complete = 'dummy_worksheet.pdf';
