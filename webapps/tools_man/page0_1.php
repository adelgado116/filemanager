...
//Class_Initialize Event @2-0392A7B1
...
//DataSource Variables @2-1D6AE090
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-5EEA9904
    function clstoolsDataSource(& $Parent)
    {
        ...
        $this->InsertFields["tool_description"] = array("Name" => "tool_description", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["tool_category_id"] = array("Name" => "tool_category_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["tool_type_id"] = array("Name" => "tool_type_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        ...
        $this->InsertFields["date_of_purchase"] = array("Name" => "date_of_purchase", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["s_n"] = array("Name" => "s_n", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["voltage"] = array("Name" => "voltage", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["last_calibration_date"] = array("Name" => "last_calibration_date", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["regular_user_id"] = array("Name" => "regular_user_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["current_user_id"] = array("Name" => "current_user_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["tool_status_id"] = array("Name" => "tool_status_id", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->InsertFields["next_calibration_date"] = array("Name" => "next_calibration_date", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
...
//Insert Method @2-202BE765
    function Insert()
    {
        ...
        $this->InsertFields["tool_description"]["Value"] = $this->tool_description->GetDBValue(true);
        $this->InsertFields["tool_category_id"]["Value"] = $this->tool_category_id->GetDBValue(true);
        $this->InsertFields["tool_type_id"]["Value"] = $this->tool_type_id->GetDBValue(true);
        $this->InsertFields["supplier_id"]["Value"] = $this->supplier_id->GetDBValue(true);
        $this->InsertFields["manufacturer_id"]["Value"] = $this->manufacturer_id->GetDBValue(true);
        $this->InsertFields["date_of_purchase"]["Value"] = $this->date_of_purchase->GetDBValue(true);
        $this->InsertFields["s_n"]["Value"] = $this->s_n->GetDBValue(true);
        $this->InsertFields["voltage"]["Value"] = $this->voltage->GetDBValue(true);
        $this->InsertFields["last_calibration_date"]["Value"] = $this->last_calibration_date->GetDBValue(true);
        $this->InsertFields["regular_user_id"]["Value"] = $this->regular_user_id->GetDBValue(true);
        $this->InsertFields["current_user_id"]["Value"] = $this->current_user_id->GetDBValue(true);
        $this->InsertFields["tool_status_id"]["Value"] = $this->tool_status_id->GetDBValue(true);
        $this->InsertFields["next_calibration_date"]["Value"] = $this->next_calibration_date->GetDBValue(true);
        $this->InsertFields["location"]["Value"] = $this->location->GetDBValue(true);
        $this->InsertFields["price"]["Value"] = $this->price->GetDBValue(true);
        $this->SQL = CCBuildInsert("tools", $this->InsertFields, $this);
...
//Include events file @1-C923701D
include_once("./page0_1_events.php");
