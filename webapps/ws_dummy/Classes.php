...
//clsFileUpload Class @0-2E2CCA27
class clsFileUpload
{
...
class clsCaptcha {
    ...
    function clsCaptcha($Name, $Caption = "", $InitValue, $Width, $Height, $SessionName, & $Parent) {
        $this->Name       = $Name;
        $this->Parent     = & $Parent;
        $this->Visible    = true;
